...
with Session(engine) as session:
    cliente1 = Cliente(
        name = 'Livia',
        fullname = 'Livia Alves',
        cpf = '00000000001',
        address = 'liviaalves@mail.com',
        conta= [Conta(type_account="conta corrente", agencia = '0001', numero = 1000, saldo = 1000)]
    ...
    cliente2 = Cliente(
        ...
        conta= [Conta(type_account="conta corrente", agencia = '0002', numero = 2002, saldo = 2000)]
    )
    ...
    cliente3 = Cliente(
        ...
        cpf = '00000000003',
        address = 'mariasantos@mail.com',
        conta= [Conta(type_account="poupanca", agencia = '0003', numero = 3003, saldo = 3000)]
    )
